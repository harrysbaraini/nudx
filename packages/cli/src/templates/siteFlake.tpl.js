export default {"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "      "
    ...
    + " = import "
    + alias2(alias1((depths[1] != null ? lookupProperty(depths[1],"filesDir") : depths[1]), depth0))
    + "/nix/"
  ...
  return "{\n  inputs = {\n    nixpkgs = { url = \"github:NixOS/nixpkgs\"; };\n    flake-utils = { url = \"github:numtide/flake-utils\"; };\n  };\n\n  outputs = { self, nixpkgs, flake-utils }:\n  flake-utils.lib.eachDefaultSystem (system:\n  let\n    pkgs = import nixpkgs {\n      inherit system;\n\n      # Makes the config pure as well.\n      config.allowBroken = true;\n      config.allowUnfree = true;\n      config.permittedInsecurePackages = [\n        \"openssl-1.1.1t\"\n      ];\n    };\n\n    ### Services\n    services = {\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"services") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":23,"column":6},"end":{"line":29,"column":15}}})) != null ? stack1 : "")
    + "    };\n\n    cli = import "
    + alias4(((helper = (helper = lookupProperty(helpers,"filesDir") || (depth0 != null ? lookupProperty(depth0,"filesDir") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"filesDir","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":32,"column":17},"end":{"line":32,"column":29}}}) : helper)))
    + "/nix/cli.nix {\n        inherit pkgs;\n        inherit system;\n        envPrefix = \""
    ...
    + "\";\n        directory = \""
    + alias4(container.lambda(((stack1 = (depth0 != null ? lookupProperty(depth0,"project") : depth0)) != null ? lookupProperty(stack1,"shellenvPath") : stack1), depth0))
