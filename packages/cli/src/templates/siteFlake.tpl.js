export default {"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "{\n  inputs = {\n    nixpkgs = { url = \"github:NixOS/nixpkgs\"; };\n    flake-utils = { url = \"github:numtide/flake-utils\"; };\n  };\n\n  outputs = { self, nixpkgs, flake-utils }:\n  flake-utils.lib.eachDefaultSystem (system:\n  let\n    pkgs = import nixpkgs {\n      inherit system;\n\n      # Makes the config pure as well.\n      config.allowBroken = true;\n      config.allowUnfree = true;\n      config.permittedInsecurePackages = [\n        \"openssl-1.1.1t\"\n      ];\n    };\n\n    ### Services\n    services = {\n"
    ...
    + "\";\n        services = services;\n    };\n\n    generated_at = \""
    + alias4(((helper = (helper = lookupProperty(helpers,"generatedAt") || (depth0 != null ? lookupProperty(depth0,"generatedAt") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"generatedAt","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":40,"column":20},"end":{"line":40,"column":35}}}) : helper)))
    + "\";\n  in\n  {\n    packages = cli.packages;\n\n    devShell = cli.lib.mkShell {\n      name = \""
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":46,"column":14},"end":{"line":46,"column":20}}}) : helper)))
