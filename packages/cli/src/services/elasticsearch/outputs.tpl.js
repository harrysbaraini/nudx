export default {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "elasticsearch.pkg = pkgs."
    ...
    + "'';\n\nelasticsearch.files.logConfig = pkgs.writeText \"log4j2.properties\" ''\n  logger.action.name = org.elasticsearch.action\n  logger.action.level = info\n  appender.console.type = Console\n  appender.console.name = console\n  appender.console.layout.type = PatternLayout\n  appender.console.layout.pattern = [%d{ISO8601}][%-5p][%-25c{1.}] %marker%m%n\n  rootLogger.level = info\n  rootLogger.appenderRef.console.ref = console\n'';\n\nelasticsearch.scripts.run = pkgs.writeShellScript \"runElasticSearch\" ''\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"options") : depth0)) != null ? lookupProperty(stack1,"port") : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data,"loc":{"start":{"line":26,"column":2},"end":{"line":30,"column":9}}})) != null ? stack1 : "")
    + "\n  echo \"NUDX_ES_PORT=$PORT\" >> ${env.PROJECT_SHELL_ENV}\n  export NUDX_ES_PORT=$PORT\n\n  if [[ ! -d \""
