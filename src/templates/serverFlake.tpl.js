export default {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "{\n  # Flake inputs\n  inputs = {\n      nixpkgs.url = \"github:NixOS/nixpkgs\";\n      flake-utils = { url = \"github:numtide/flake-utils\"; };\n  };\n\n  # Flake outputs\n  outputs = { self, nixpkgs, flake-utils }:\n  flake-utils.lib.eachDefaultSystem (system:\n  let\n    pkgs = import nixpkgs { inherit system; };\n\n    # Build Caddy\n    caddy = with pkgs; stdenv.mkDerivation rec {\n      pname = \"caddy\";\n      version = \"2.6.4\";\n      dontUnpack = true;\n      nativeBuildInputs = [ git go xcaddy ];\n      plugins = [\n        \"github.com/mholt/caddy-l4/layer4\"\n        \"github.com/mholt/caddy-l4/modules/l4http\"\n        \"github.com/mholt/caddy-l4/modules/l4proxy\"\n      ];\n\n      configurePhase = ''\n        export GOCACHE=$TMPDIR/go-cache\n        export GOPATH=\"$TMPDIR/go\"\n      '';\n\n      buildPhase = let\n        pluginArgs = lib.concatMapStringsSep \" \" (plugin: \"--with ${plugin}\") plugins;\n      in ''\n        runHook preBuild\n        ${xcaddy}/bin/xcaddy build \"v${version}\" ${pluginArgs}\n        runHook postBuild\n      '';\n\n      installPhase = ''\n        runHook preInstall\n        mkdir -p $out/bin\n        mv caddy $out/bin\n        runHook postInstall\n      '';\n    };\n\n    basicCaddyConfig = pkgs.writeText \"Caddyfile\" ''\n      "
    ...
    + "/nudx.lock\";\n    env.CLI_PORTS=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"statePath") || (depth0 != null ? lookupProperty(depth0,"statePath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"statePath","hash":{},"data":data,"loc":{"start":{"line":54,"column":19},"end":{"line":54,"column":32}}}) : helper)))
    + "/ports.txt\";\n    env.CLI_PROCESSES_FILE=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"configPath") || (depth0 != null ? lookupProperty(depth0,"configPath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"configPath","hash":{},"data":data,"loc":{"start":{"line":55,"column":28},"end":{"line":55,"column":42}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"statePath") || (depth0 != null ? lookupProperty(depth0,"statePath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"statePath","hash":{},"data":data,"loc":{"start":{"line":69,"column":18},"end":{"line":69,"column":31}}}) : helper)))
    + "\" ]]; then\n        mkdir -p "
    + alias4(((helper = (helper = lookupProperty(helpers,"statePath") || (depth0 != null ? lookupProperty(depth0,"statePath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"statePath","hash":{},"data":data,"loc":{"start":{"line":70,"column":17},"end":{"line":70,"column":30}}}) : helper)))
    + "\n      fi\n\n      # Create ports file\n      if [[ -f \"${env.CLI_PORTS}\" ]]; then\n        rm -f ${env.CLI_PORTS}\n      fi\n\n      touch ${env.CLI_PORTS}\n\n      runningMode=$1\n      shift\n\n      if [[ $runningMode == \"daemon\" ]]; then\n        ${pkgs.daemonize}/bin/daemonize -p ${env.CLI_PID} -l ${env.CLI_LOCK} -c "
    + alias4(((helper = (helper = lookupProperty(helpers,"statePath") || (depth0 != null ? lookupProperty(depth0,"statePath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"statePath","hash":{},"data":data,"loc":{"start":{"line":84,"column":80},"end":{"line":84,"column":93}}}) : helper)))
    + " ${pkgs.process-compose}/bin/process-compose up $@ -t=false -f ${env.CLI_PROCESSES_FILE}\n        echo \"Server started!\"\n      elif [[ $runningMode == \"tui\" ]]; then\n        exec ${pkgs.process-compose}/bin/process-compose up $@ -f ${env.CLI_PROCESSES_FILE}\n      else\n        echo \"First argument cannot be processed! It must be 'daemon' or 'tui'\"\n        exit 1;\n      fi\n    '';\n\n    # Packages\n    packages = with pkgs; [process-compose caddy startServer stopServer runCaddy];\n  in\n  {\n    devShell = pkgs.mkShell {\n      buildInputs = packages;\n\n      shellHook = ''\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"sites") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":102,"column":8},"end":{"line":108,"column":17}}})) != null ? stack1 : "")
    + "      '';\n    };\n  });\n}\n";
},"useData":true}